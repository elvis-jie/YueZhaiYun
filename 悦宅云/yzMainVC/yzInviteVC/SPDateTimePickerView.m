...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.arr = @[@{@"title":@"上午",@"id":@"15553945802567497340247589466362"},@{@"title":@"下午",@"id":@"15553945961768726175448059294084"},@{@"title":@"晚间",@"id":@"15553946050435300695204838800502"}];
...
-(void)setCurrentDate:(NSDate *)currentDate
{
    ...
    selectedMonth    = month;
    selectedDay      = day;
    selectedHour     = @{@"title":@"上午",@"id":@"15553945802567497340247589466362"};
...
- (UIView*)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view
{
    ...
    label.textAlignment = NSTextAlignmentCenter;
            ...
            switch (component) {
                ...
                case 3:
                {
                    label.text=[NSString stringWithFormat:@"%@",[self.arr[row] objectForKey:@"title"]];
                }
                    break;
...
- (void)showDateTimePickerView{
    ...
    [UIView animateWithDuration:0.25f animations:^{
        self.alpha = 1;
        self.contentView.frame = CGRectMake(0, ScreenHeight-220 - 104, ScreenWith, 220);
...
-(void)configButtonClick
{
    ...
    [mutDic setObject:[selectedHour objectForKey:@"id"] forKey:@"id"];
    if (self.delegate != nil && [self.delegate respondsToSelector:@selector(didClickFinishDateTimePickerView:dic:)]) {
        [self.delegate didClickFinishDateTimePickerView:_string dic:mutDic];
    }
