//
//  yzFuWuWebController.m
//  悦宅云
//
//  Created by 尚广杰 on 2019/5/13.
//  Copyright © 2019 尚广杰. All rights reserved.
//

#import "yzFuWuWebController.h"
#import <WebKit/WebKit.h>
@interface yzFuWuWebController ()<WKUIDelegate>
@property(nonatomic,strong)WKWebView* webView;
@property(nonatomic,strong)UILabel* titleLabel;
@end

@implementation yzFuWuWebController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [_titleLabel setFrame:CGRectMake(0, 0, mDeviceWidth/4*3, NavTopHeight)];
    [_titleLabel setFont:YSize(18)];
