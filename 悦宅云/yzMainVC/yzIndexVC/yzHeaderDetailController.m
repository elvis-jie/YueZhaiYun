//
//  yaHeaderDetailController.m
//  悦宅云
//
//  Created by 尚广杰 on 2020/1/2.
//  Copyright © 2020 尚广杰. All rights reserved.
//

#import "yzHeaderDetailController.h"

@interface yzHeaderDetailController ()<UIWebViewDelegate>
@property(nonatomic,strong)UIWebView* webView;

@end

@implementation yzHeaderDetailController
...
- (void)viewDidLoad {
    ...
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:self.advURL]]];
