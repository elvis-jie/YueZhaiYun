...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.backView = [[UIView alloc]initWithFrame:CGRectMake(3, 3, mDeviceWidth - 40 - 6, 95)];
...
//        self.backView.layer.masksToBounds = YES;
        ...
        //价格
        self.moneyLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, 20, mDeviceWidth - 60 - 6, 37)];
        
        self.moneyLabel.font = YSize(16);
        self.moneyLabel.textAlignment = NSTextAlignmentCenter;
        [self.backView addSubview:self.moneyLabel];
        //横线
        self.line = [[UIView alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(self.moneyLabel.frame), mDeviceWidth - 60 - 6, 1)];
        [self.line setBackgroundColor:[UIColor lightGrayColor]];
        [self.backView addSubview:self.line];
        //基础费
        self.desLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(self.line.frame), mDeviceWidth - 60 - 6, 37)];
