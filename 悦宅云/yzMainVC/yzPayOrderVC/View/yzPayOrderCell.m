...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
      //icon
        ...
        self.priceLab = [[UILabel alloc]initWithFrame:CGRectMake(mDeviceWidth - 95, 5, 80, 20)];
        ...
        self.typeLab = [[UILabel alloc]initWithFrame:CGRectMake(mDeviceWidth - 95, 30, 80, 20)];
...
-(void)getMessageByDic:(NSDictionary *)dic{
    ...
    self.titleLab.text = [BBUserData stringChangeNull:[dic objectForKey:@"orderName"] replaceWith:@""];
    self.quLab.text = [BBUserData stringChangeNull:[dic objectForKey:@"shopName"] replaceWith:@""];
     self.timeLab.text = [BBUserData stringChangeNull:[dic objectForKey:@"orderTime"] replaceWith:@""];
