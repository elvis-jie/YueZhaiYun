...
//        progressView.progress = 0.5;
        ...
        [photo sd_setImageWithPreviousCachedImageWithURL:[NSURL URLWithString:self.urlArr[i]] placeholderImage:nil options:SDWebImageRetryFailed | SDWebImageLowPriority progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
