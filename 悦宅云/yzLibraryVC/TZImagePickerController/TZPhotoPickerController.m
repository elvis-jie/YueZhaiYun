...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self setStatusBarBackgroundColor:RGBA(248, 0, 92, 1)];
    [self.navigationController.navigationBar setBackgroundColor:RGBA(248, 0, 92, 1)];
...
- (void)configBottomToolBar {
    ...
    _doneButton.enabled = YES;//tzImagePickerVc.selectedModels.count || tzImagePickerVc.alwaysEnableDoneBtn;
...
- (void)refreshBottomToolBarStatus {
    ...
    _doneButton.enabled = YES;//tzImagePickerVc.selectedModels.count > 0 || tzImagePickerVc.alwaysEnableDoneBtn;
