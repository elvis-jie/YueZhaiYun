...
//    [picker.navigationBar setColor:NewAppDefaultColor];
    ...
    if ([metadataObjects count] >0){
        ...
        if (metadataObject.stringValue.length != 0) {
            ...
            if (self.scanDelegate && [self.scanDelegate respondsToSelector:@selector(DCScanningSucessBackWithInfor:)]) {
                ...
                __weak typeof(self)weakSelf = self;
//                [DCScanTool setUpAlterViewWith:self WithReadContent:@"此功能努力开发中..." WithLeftMsg:@"好的" LeftBlock:^{
//                    
//                    [weakSelf.navigationController popViewControllerAnimated:YES];
//                    
//                } RightMsg:nil RightBliock:nil];
                
                if ([metadataObject.stringValue hasPrefix:@"http"]||[metadataObject.stringValue hasPrefix:@"HTTP"]) {
                    WebViewController* vc = [[WebViewController alloc]init];
                    vc.urlStr = metadataObject.stringValue;
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (arrayM.copy != nil && ![arrayM isKindOfClass:[NSNull class]] && arrayM.count != 0) {
                ...
                if ([str hasPrefix:@"http"]||[str hasPrefix:@"HTTP"]) {
                    ...
                    [DCScanTool setUpAlterViewWith:self WithReadContent:[NSString stringWithFormat:@"扫描结果为：%@",str] WithLeftMsg:@"好的" LeftBlock:^{
