...
+ (JYEmptyView *)showTitle:(NSString *)title
                  ...
                  iconImag:(NSString *)imageName isShowRefreshBtn:(BOOL)isShow {
...
- (void)layoutSubviews {
    ...
    CGFloat topBottomMargin = (self.height - contentHeight) / 2.5;
...
- (UIButton *)refreshBtn {
    if(!_refreshBtn) {
        ...
        _refreshBtn.layer.borderColor = NewAppDefaultColor.CGColor;
        _refreshBtn.layer.borderWidth = 0.5;
        [_refreshBtn setTitleColor:NewAppDefaultColor forState:UIControlStateNormal];
