...
NSString * const reuseID = @"TjcclzCirleImageCell";
static const NSInteger kInfiniteLoopMultiple = 1000;

@interface TjcclzCirclePlayImageView()<UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation TjcclzCirclePlayImageView
...
+ (instancetype)rotatorImageViewWithFrame:(CGRect)frame
    ...
    TjcclzCirclePlayImageView *rotatorImageView = [[self alloc] initWithFrame:frame];
...
- (UICollectionView *)colletcionView {
    if (!_colletcionView) {
        ...
        [_colletcionView registerClass:[TjcclzCirleImageCell class] forCellWithReuseIdentifier:reuseID];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    TjcclzCirleImageCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseID forIndexPath:indexPath];
