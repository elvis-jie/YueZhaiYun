...
@class TjcclzCirclePlayImageView;
@protocol TjcclzCirclePlayImageViewDelegate<NSObject>
...
@interface TjcclzCirclePlayImageView : UIView
/**
 *  初始化轮播图,图片从网络获取
 *
 *  @param frame                显示frame
...
@property (nonatomic, weak) id<TjcclzCirclePlayImageViewDelegate> delegate;
